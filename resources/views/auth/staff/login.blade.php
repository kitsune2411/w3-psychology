            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  @endif
                  <form class="user" action="{{ route('staff.login') }}" method="post" enctype="multipart/form-data">
                      @csrf
                  ...
                  <span class="d-block mt-2 text-left text-muted"><a href="{{ url('/psychologist/login')}}" class="forgot-pass">Login as psychologist</a></span>
                    <span class="d-block text-right mt-n4 text-muted"><a href="{{ url('/login')}}" class="forgot-pass">Login as patient</a></span>
                  {{-- <div class="text-center">
