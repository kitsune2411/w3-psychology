    ...
    <div class="container">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body my-2 mx-3">
                <form action="{{route('update3',['id' => $us->id])}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" name="name" value="{{$us->name}}" class="form-control mt-2" required>
                    </div>

                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" name="email" value="{{$us->email}}" class="form-control mt-2" required>
                    </div>

                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="text" name="phone_number" value="{{$us->phone_number}}" class="form-control mt-2" required>
                    </div>
                ...
                </form>r="password">password</label>
