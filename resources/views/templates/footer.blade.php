<footer class="footer-1 bg-gray-100 pt-8 sm:pt-12">
    <div class="container mx-auto px-4 pl-12">
      ...
      <div class="sm:flex sm:flex-wrap sm:-mx-4 mt-6 py-3 sm:mt-6 sm:py-6 border-t">
        <div class="mx-5">© Copyright {{ date('Y') }}. All Rights Reserved.</div>
    </div>
  </footer>